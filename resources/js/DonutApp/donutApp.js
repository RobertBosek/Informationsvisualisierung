...
//Pie-Chart based on: https://bl.ocks.org/mbostock/3887193
    ...
    function doDonut() {
        ...
        d3.json("data/database/people.json", function (data) {
            ...
            ////METHOD TO EXTRACT PEOPLE OBJECT IDs
			...
			//CHANGES COLORSET DEPENDING ON THE ID OF THE SELECTED RADIO BUTTON	
			...
			//METHODE TO GET THE ID OF THE RADIO BUTTON
			...
			//CREATES THE DONUTCHART INCLUDING MOUSEOVER/-OUT EFFECTS
			...
			//CALLED WHEN ANOTHER RADIOBUTTON IS CLICKED.
			//ACTUALISES THE DOUNTPIE WITH THE NEW DATASET AND SWITCHING THE COLORS DEPENDING ON THE ID OF THE CLICKED BUTTON.
